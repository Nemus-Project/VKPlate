...
load("./param/parameter_clamped_1.mat"); %Parameter file is generated by main
...
for n=1:Ts
    if abs(n*k-T0) <Thw
        Fext1(1,n)=0.5*c0*(1+cos(pi*(n*k-T0)/Thw));
    end
end
for n=1:Ts
    if abs(n*k-T2) <Thw
