...
xi=0e-2*Id;                                     % Modal damping matrix
...
%qm(1)=1e-6;                                     % Initialisation of the displacement at n-1
...
for n = 2 : Ts
    ...
    qs=DexpL*(Dq0L*q0+DqmL*qm-g*(k^2)*psim1); % SAV exact lossy 
